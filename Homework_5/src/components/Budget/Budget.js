  ...
  render() {
    ...
    return (
      <div className="budget">
        ...
        <p>
          Расходы продавцов:{' '}
          <span className="t-sellers">{this.checkNegate(sellers)}</span>
        </p>
        <p>
          Расходы на ферме:{' '}
          <span className="t-farm">{this.checkNegate(farm)}</span>
        </p>
        <p>
          Расходы на доставку:{' '}
          <span className="t-delivery">{this.checkNegate(delivery)}</span>
        </p>
        <p>
